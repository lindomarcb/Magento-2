<?php
namespace MSP\Shield\Command\Test;

/**
 * Interceptor class for @see \MSP\Shield\Command\Test
 */
class Interceptor extends \MSP\Shield\Command\Test implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\MSP\Shield\Api\IpsInterface $ips)
    {
        $this->___init();
