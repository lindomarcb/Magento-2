<?php
namespace UOL\PagSeguro\Model\PaymentDefaultlLightbox;

/**
 * Interceptor class for @see \UOL\PagSeguro\Model\PaymentDefaultlLightbox
 */
class Interceptor extends \UOL\PagSeguro\Model\PaymentDefaultlLightbox implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $extensionFactory, $attributeFactory, $paymentData, $scopeConfig, $logger, $cart);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isDirectCheckout');
        if (!$pluginInfo) {
            return parent::isDirectCheckout();
        } else {
            return $this->___callPlugins('isDirectCheckout', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isLightboxCheckoutType');
        if (!$pluginInfo) {
            return parent::isLightboxCheckoutType();
        } else {
            return $this->___callPlugins('isLightboxCheckoutType', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLightboxCheckoutPaymentUrl');
        if (!$pluginInfo) {
            return parent::getLightboxCheckoutPaymentUrl();
        } else {
            return $this->___callPlugins('getLightboxCheckoutPaymentUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStandardCheckoutPaymentUrl');
        if (!$pluginInfo) {
            return parent::getStandardCheckoutPaymentUrl();
        } else {
            return $this->___callPlugins('getStandardCheckoutPaymentUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDirectCheckoutPaymentUrl');
        if (!$pluginInfo) {
            return parent::getDirectCheckoutPaymentUrl();
        } else {
            return $this->___callPlugins('getDirectCheckoutPaymentUrl', func_get_args(), $pluginInfo);
        }
    }
