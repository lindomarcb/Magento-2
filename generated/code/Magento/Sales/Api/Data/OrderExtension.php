...
class OrderExtension extends \Magento\Framework\Api\AbstractSimpleObject implements OrderExtensionInterface
{
     ...
     * @return string|null
     */
    public function getBoldOrderComment()
    {
        return $this->_get('bold_order_comment');
    }

    /**
     * @param string $boldOrderComment
     * @return $this
     */
    public function setBoldOrderComment($boldOrderComment)
    {
        $this->setData('bold_order_comment', $boldOrderComment);
        return $this;
    }
}
